        ...
        <div class="card-body">
          <div class="row">
            <div class="col-md-8 offset-md-2 text-center">
              ...
              <p>A continuación se muestra la información básica sobre la peticion seleccionada.</p>
            </div>
          </div>
          <hr/>
          <div class="row">
            <div class="col-md-8 pr-2">
              ...
              <div>
                ...
                <div class="form-group row">
                  ...
                  <div class="col-md-5">
                    {!! Form::text('company_name', Auth::user()->
                    company_name, ['class' =>
                    'form-control','required']) !!}
                  </div>
                </div>
                ...
                <div class="form-group">
                  ...
                  'form-control','placeholder' => '(Opcional) Puedes enviar más detalles tu empresa', 'rows' => '5' ]) !!}
                </div>
                <div class="form-group">
            ...
            <div class="col-md-4 d-flex flex-column justify-content-between pr-2" id="info-column">
              <div id="info-inner" class="d-flex flex-column justify-content-around">
                <div  class="d-flex justify-content-center">
                  <h2>${{ $petition->rate }}</h2>
                  <span class="pl-1 pt-2">dlls.</span>
                </div>
