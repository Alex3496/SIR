...
<div class="container-fluid">
  <div class="row">
    <div class="col">
      <h2 class="mb-4">{{ __('Lista de tarifas del usario') }}: que pedo</h2>
    </div>
  </div>
  ...
  <div class="row">
    <div class="col-12">
      ...
      @if(isset($truckTariffs) && !count($truckTariffs) == 0)
        @include('Admin.Users.tariffs.truck')
      @endif
      <!--/end card-->

      <!--start train card-->
      @if(isset($trainTariffs) && !count($trainTariffs) == 0)
        @include('Admin.Users.tariffs.train')
      @endif
      <!--/end card-->

      <!--start train card-->
      @if(isset($maritimeTariffs) && !count($maritimeTariffs) == 0)
        @include('Admin.Users.tariffs.maritime')
      @endif
      <!--/end card-->

      <!--start train card-->
      @if(isset($aerialTariffs) && !count($aerialTariffs) == 0)
        @include('Admin.Users.tariffs.aerial')
      @endif
      <!--/end card-->
    </div>
  </div>
